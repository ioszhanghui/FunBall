...
-(void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSString *,id> *)change context:(void *)context {
    ...
    if ([[NSString stringWithFormat:@"%@",keyPath] isEqualToString:@"text"]&&![[change objectForKey:@"new"]isEqualToString:@"请选择"]&&self.change) {
    ...
    if ([[NSString stringWithFormat:@"%@",keyPath] isEqualToString:@"text"]&&([[change objectForKey:@"new"]isEqualToString:@"已完善"]||[[change objectForKey:@"new"]isEqualToString:@"已认证"])) {
        
        self.textColor=ZHThemeColor;
        self.textAlignment=NSTextAlignmentRight;
    }
    
    
    if ([[NSString stringWithFormat:@"%@",keyPath] isEqualToString:@"text"]&&([[change objectForKey:@"new"]isEqualToString:@"未完善"]||[[change objectForKey:@"new"]isEqualToString:@"未认证"])) {
